...
export const NOTIFICATIONS: NotificationItem[] = [
    ...
    { id: 4, title: 'Bem-vindo ao Portal', body: 'Sua conta foi criada com sucesso. Comece explorando o seu dashboard.', time: '3 dias atrás', icon: 'sparkle', tone: 'lavender', read: true },
];
